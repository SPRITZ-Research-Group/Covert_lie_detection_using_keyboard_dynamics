    ...
    <body>
        ...
        <form action="" method="post" name="informForm"  style="margin-bottom:0px;" >
            <table class=" table table-striped">
                <tr>
                    <td class="text-center" bgcolor="#EBEBEB">Istruzioni.</td>
                </tr>
                <tr >
                    <td  align="left" bgcolor="#FFFFFF" >
                        <p class="text-justified">
                        Rispondi alle domande che ti verranno proposte di seguito <b>basandoti sulle informazioni che hai precedentemente inserito all’interno della tua carta d’identità</b>.<br/><br/>
                        Rispondi in modo accurato ad ogni domanda digitando la risposta nell’apposito riquadro. Premi ENTER per confermare la risposta e proseguire con la domanda successiva.<br/><br/>
                        Una barra sottostante ti indicherà la percentuale di completamento del test.<br/><br/>
                        Prima di iniziare il test ti verranno poste alcune domande di prova con lo scopo di familiarizzare con il compito. Rivolgiti allo sperimentatore per qualunque dubbio riguardante lo svolgimento del compito.</p>
                    </td>
                </tr>
